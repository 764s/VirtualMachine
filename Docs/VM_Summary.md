...
| *DX4-P2* | *CLI 项目编译集成* | *⏳* | *`ffvm-cli compile --project x.ffproj` 读取 `.ffproj` 构建编译参数。LSP 和 CLI 使用相同的项目配置。讨论来源 → [D_Usability_ModuleScope.md](Discussion/D_Usability_ModuleScope.md)* | *CLI 生产编译* | *CLI* | *⭐⭐* |
...
| 易用性 (DX4) | **DX4-P0 LSP workspace ⏳**、**DX4-P1 .ffproj ⏳**、**DX4-P2 CLI 项目编译 ⏳**、**DX4-P3 跨文件符号 ⏳** | — |
