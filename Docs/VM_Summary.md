...
| 易用性 (DX4) | **DX4-P0 LSP workspace ✅**、**DX4-P1 .ffproj ✅**、**DX4-P2 CLI 项目编译 + init 脚手架 ✅**、**DX4-P3 跨文件符号 ⏳** | — |
