...
| 脚本调试 | — | DBG1-DBG7 全部 ✅ |
| 语言服务 | — | LSP1-LSP7 全部 ✅ |
| Include As | **Lang-18 Override Alias（待实施）**、IA-F1 LSP（暂缓）、IA-F3 变量读写（暂缓不推荐） | Lang-17 ✅ |
