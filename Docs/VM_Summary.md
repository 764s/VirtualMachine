...
| **DX10** | **依赖图 + 全项目诊断** | **⚪** | Include 依赖图数据结构（`_includeDependents`）+ 变更时按依赖图重编译受影响文件 + `workspace/didChangeWatchedFiles` 处理。讨论来源 → [D_LspArchitecture.md](Discussion/D_LspArchitecture.md) | *全项目错误可见性* | *LSP Server* | *⭐⭐⭐* |
