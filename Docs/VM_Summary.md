...
| 易用性 (DX4~DX5) | **DX4-P0 LSP workspace ✅**、**DX4-P1 .ffproj ✅**、**DX4-P2 CLI 项目编译 + init 脚手架 ✅**、**DX4-P3 跨文件符号 ✅**、**DX4-P4 LSP 辅助创建 .ffproj ✅**、**DX5 LSP 重命名 + 语义染色 + Include 导航 + 成员符号 ✅** | DX6 ⏳ Include 文件重命名、DX7 ⏳ AST 精确位置追踪 |
