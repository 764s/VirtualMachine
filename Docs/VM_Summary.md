...
| **DX11** | **VFS + Rename 状态更新** | **🟡** | 统一文件内容提供器（VFS/Overlay）+ Rename 后 URI/缓存/依赖图状态更新 → 修复连续重命名失败。讨论来源 → [D_LspArchitecture.md](Discussion/D_LspArchitecture.md) | *rename 一致性* | *LSP Server* | *⭐⭐* |
