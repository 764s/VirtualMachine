...
Docs/
  ...
  Discussion/                ← 讨论区：设计探讨 / 方案对比 / 决策记录
    ...
    D_Usability_ModuleScope.md       易用性补充：语法信息来源范围 × 编译方式（✅ 已完成 → DX4 系列）
  Plan/                      ← 计划区：确定步骤 / 无脑执行
...
| 易用性 (DX4) | **DX4-P0 LSP workspace ✅**、**DX4-P1 .ffproj ✅**、**DX4-P2 CLI 项目编译 + init 脚手架 ✅**、**DX4-P3 跨文件符号 ✅**、**DX4-P4 LSP 辅助创建 .ffproj ✅** | — |
