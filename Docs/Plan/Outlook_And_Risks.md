...
| **DX18** | 统一引用收集 | ⏳ | 7 个引用 Walker（CallRefs/IdentRefs/TypeRefs/StructLiteralTypeRefs/EnumIdentRefs/FieldAccessRefs/EnumMemberAccessRefs）→ 1 个 UnifiedRefsWalker。CollectReferencesWithOrigin 8 个 SymbolKindTag 分支 → 声明位置 + 统一遍历入口。消除 CollectReferences/CollectReferencesWithOrigin 二重性。656 现有 LSP 测试提供回归保障。讨论来源 → [D_LspStructuralAudit.md](../Discussion/D_LspStructuralAudit.md) §五 P2+P3 | DX17 ✅ |

> Lang-18 ✅ 完成。DX4-P0 ✅ 完成。DX4-P1 ✅ 完成。DX4-P2 ✅ 完成。DX4-P3 ✅ 完成。DX4-P4 ✅ 完成。DX5 ✅ 完成。DX6 ✅ 完成。DX7 ✅ 完成。DX8 ✅ 完成。DX9 ✅ 完成。E003 ✅ 完成。R1 ✅ 完成。E004 ✅ 完成。DX10 ✅ 完成。DX11 ✅ 完成。DX13 ✅ 完成。DX14 ✅ 完成。DX15 ✅ 完成。DX16 ✅ 完成。DX17 ✅ 完成。2282 测试总计（656 LSP）。DX12 ⚪ 远期待激活。DX18 ⏳ 统一引用收集。当前位置 → DX18。
