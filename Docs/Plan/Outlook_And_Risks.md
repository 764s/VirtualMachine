...
| **CM** | LSP 覆盖矩阵基座 | 🟡 Phase 0 ✅ / Phase 1~3 ⚪ 远期 | 两层矩阵（语法结构层 AST 节点族/子位置 + 语义覆盖层 A×B×C）。Phase 0 人工基线：[Map_CM_CoverageMatrix.md](LSP/Map_CM_CoverageMatrix.md) 含 GAP-01~04（Database 后端 call-ref 遍历缺口）。纯文档基座，不改 LspServer。CM1 生成器 / CM2 投影器 / CM3 测试标签化 / CM4 CI 守卫 列为可选 Phase，业务驱动激活。计划 → [Step_CM_CoverageMatrix.md](LSP/Step_CM_CoverageMatrix.md)　讨论来源 → [D_CoverageMatrix.md](../Discussion/D_CoverageMatrix.md) | DX19 ✅ |

> Lang-18 ✅ 完成。DX4-P0 ✅ 完成。DX4-P1 ✅ 完成。DX4-P2 ✅ 完成。DX4-P3 ✅ 完成。DX4-P4 ✅ 完成。DX5 ✅ 完成。DX6 ✅ 完成。DX7 ✅ 完成。DX8 ✅ 完成。DX9 ✅ 完成。E003 ✅ 完成。R1 ✅ 完成。E004 ✅ 完成。DX10 ✅ 完成。DX11 ✅ 完成。DX13 ✅ 完成。DX14 ✅ 完成。DX15 ✅ 完成。DX16 ✅ 完成。DX17 ✅ 完成。DX18 ✅ 完成。DX19 ✅ 完成。CM Phase 0 ✅ 完成（人工基线 Map 落地）。2301 测试总计（675 LSP）。DX12 ⚪ 远期待激活。CM1~CM4 ⚪ 远期待激活。
> **DX13~DX19 ALL ✅。无待执行 DX 步骤。DX12 ⚪ 远期。CM Phase 0 ✅ / Phase 1~3 ⚪ 业务驱动。**
