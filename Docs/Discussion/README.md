...
| D16 | [D_LspArchitecture.md](D_LspArchitecture.md) | LSP 架构演进：全项目诊断、状态管理与增量更新 | 💬 讨论中 | 2026-04-13 | E003 暴露的架构性问题。连续 rename 失败根因分析 + 全项目诊断需求 + 依赖图/VFS/后台调度前置功能 + 跨语言对比。→ 远期 DX10~DX12 |
